...
[![CI](https://github.com/bolens/archiving-utils/actions/workflows/ci.yml/badge.svg)](https://github.com/bolens/archiving-utils/actions/workflows/ci.yml)
...
30 commands cover conversion, inspection, and library maintenance. Tool directories are thin Bash entry points over a shared Python engine, following the layout and preservation intent of [audio-utils](https://github.com/bolens/audio-utils).
