...
Archive operations use Python standard-library ZIP, TAR, gzip, bz2, and lzma modules. Python must include zlib, bz2, and lzma support. Directory publication requires glibc with `renameat2`, available on supported GNU/Linux systems. No 7-Zip, RAR, encryption, or network service is required.
