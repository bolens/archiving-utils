...
## Test fixtures and external tools

`tests/fixtures/libarchive/COPYING` and `TEST-LICENSES` preserve libarchive test
fixture terms. Keep these with redistributed fixtures. Installed archive tools
are separate programs under their own licenses.
